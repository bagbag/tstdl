...
export function assertUndefined(value: any, message: string = 'expected value to be undefined'): asserts value is InferIsType<typeof isUndefined> { assert(isUndefined(value), message); }
export function assertDefined<T>(value: T, message: string = 'expected value to not be undefined'): asserts value is InferIsNotType<T, typeof isUndefined> { assert(isDefined(value), message); }
...
export function assertNull(value: any, message: string = 'expected value to be null'): asserts value is InferIsType<typeof isNull> { assert(isNull(value), message); }
export function assertNotNull<T>(value: T, message: string = 'expected value to not be null'): asserts value is InferIsNotType<T, typeof isNull> { assert(isNotNull(value), message); }
...
export function assertNullOrUndefined(value: any, message: string = 'expected value to be null or undefined'): asserts value is InferIsType<typeof isNullOrUndefined> { assert(isNullOrUndefined(value), message); }
export function assertNotNullOrUndefined<T>(value: T, message: string = 'expected value to not be null or undefined'): asserts value is InferIsNotType<T, typeof isNullOrUndefined> { assert(isNotNullOrUndefined(value), message); }
...
export function assertNumber(value: any, message: string = 'expected value to be number'): asserts value is InferIsType<typeof isNumber> { assert(isNumber(value), message); }
export function assertNotNumber<T>(value: T, message: string = 'expected value to not be number'): asserts value is InferIsNotType<T, typeof isNumber> { assert(isNotNumber(value), message); }
...
export function assertString(value: any, message: string = 'expected value to be string'): asserts value is InferIsType<typeof isString> { assert(isString(value), message); }
export function assertNotString<T>(value: T, message: string = 'expected value to not be string'): asserts value is InferIsNotType<T, typeof isString> { assert(isNotString(value), message); }
...
export function assertBoolean(value: any, message: string = 'expected value to be boolean'): asserts value is InferIsType<typeof isBoolean> { assert(isBoolean(value), message); }
export function assertNotBoolean<T>(value: T, message: string = 'expected value to not be boolean'): asserts value is InferIsNotType<T, typeof isBoolean> { assert(isNotBoolean(value), message); }
...
export function assertBigInt(value: any, message: string = 'expected value to be bigint'): asserts value is InferIsType<typeof isBigInt> { assert(isBigInt(value), message); }
export function assertNotBigInt<T>(value: T, message: string = 'expected value to not be bigint'): asserts value is InferIsNotType<T, typeof isBigInt> { assert(isNotBigInt(value), message); }
...
export function assertFunction(value: any, message: string = 'expected value to be function'): asserts value is InferIsType<typeof isFunction> { assert(isFunction(value), message); }
export function assertNotFunction<T>(value: T, message: string = 'expected value to not be function'): asserts value is InferIsNotType<T, typeof isFunction> { assert(isNotFunction(value), message); }
...
export function assertSymbol(value: any, message: string = 'expected value to be symbol'): asserts value is InferIsType<typeof isSymbol> { assert(isSymbol(value), message); }
export function assertNotSymbol<T>(value: T, message: string = 'expected value to not be symbol'): asserts value is InferIsNotType<T, typeof isSymbol> { assert(isNotSymbol(value), message); }
...
export function assertObject(value: any, message: string = 'expected value to be object'): asserts value is InferIsType<typeof isObject> { assert(isObject(value), message); }
export function assertNotObject<T>(value: T, message: string = 'expected value to not be object'): asserts value is InferIsNotType<T, typeof isObject> { assert(isNotObject(value), message); }
...
export function assertPrimitive(value: any, message: string = 'expected value to be primitive'): asserts value is InferIsType<typeof isPrimitive> { assert(isPrimitive(value), message); }
export function assertNotPrimitive<T>(value: T, message: string = 'expected value to not be primitive'): asserts value is InferIsNotType<T, typeof isPrimitive> { assert(isNotPrimitive(value), message); }
...
export function assertNotDate<T>(value: T, message: string = 'expected value to not be Date'): asserts value is InferIsNotType<T, typeof isDate> { assert(isNotDate(value), message); }
...
export function assertRegExp(value: any, message: string = 'expected value to be RegExp'): asserts value is InferIsType<typeof isRegExp> { assert(isRegExp(value), message); }
export function assertNotRegExp<T>(value: T, message: string = 'expected value to not be RegExp'): asserts value is InferIsNotType<T, typeof isRegExp> { assert(isNotRegExp(value), message); }
...
export function assertArray(value: any, message: string = 'expected value to be Array'): asserts value is InferIsType<typeof isArray> { assert(isArray(value), message); }
export function assertNotArray<T>(value: T, message: string = 'expected value to not be Array'): asserts value is InferIsNotType<T, typeof isArray> { assert(isNotArray(value), message); }
...
export function assertArrayBuffer(value: any, message: string = 'expected value to be ArrayBuffer'): asserts value is InferIsType<typeof isArrayBuffer> { assert(isArrayBuffer(value), message); }
export function assertNotArrayBuffer<T>(value: T, message: string = 'expected value to not be ArrayBuffer'): asserts value is InferIsNotType<T, typeof isArrayBuffer> { assert(isNotArrayBuffer(value), message); }
...
export function assertInt8Array(value: any, message: string = 'expected value to be Int8Array'): asserts value is InferIsType<typeof isInt8Array> { assert(isInt8Array(value), message); }
export function assertNotInt8Array<T>(value: T, message: string = 'expected value to not be Int8Array'): asserts value is InferIsNotType<T, typeof isInt8Array> { assert(isNotInt8Array(value), message); }
export function assertInt8ArrayPass(value: any, message?: string): InferIsType<typeof isInt8Array> { assertInt8Array(value, message); return value; }
export function assertNotInt8ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isInt8Array> { assertNotInt8Array(value, message); return value; }
...
export function assertUint8Array(value: any, message: string = 'expected value to be Uint8Array'): asserts value is InferIsType<typeof isUint8Array> { assert(isUint8Array(value), message); }
export function assertNotUint8Array<T>(value: T, message: string = 'expected value to not be Uint8Array'): asserts value is InferIsNotType<T, typeof isUint8Array> { assert(isNotUint8Array(value), message); }
export function assertUint8ArrayPass(value: any, message?: string): InferIsType<typeof isUint8Array> { assertUint8Array(value, message); return value; }
export function assertNotUint8ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isUint8Array> { assertNotUint8Array(value, message); return value; }
...
export function assertUint8ClampedArray(value: any, message: string = 'expected value to be Uint8ClampedArray'): asserts value is InferIsType<typeof isUint8ClampedArray> { assert(isUint8ClampedArray(value), message); }
export function assertNotUint8ClampedArray<T>(value: T, message: string = 'expected value to not be Uint8ClampedArray'): asserts value is InferIsNotType<T, typeof isUint8ClampedArray> { assert(isNotUint8ClampedArray(value), message); }
export function assertUint8ClampedArrayPass(value: any, message?: string): InferIsType<typeof isUint8ClampedArray> { assertUint8ClampedArray(value, message); return value; }
export function assertNotUint8ClampedArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isUint8ClampedArray> { assertNotUint8ClampedArray(value, message); return value; }
...
export function assertInt16Array(value: any, message: string = 'expected value to be Int16Array'): asserts value is InferIsType<typeof isInt16Array> { assert(isInt16Array(value), message); }
export function assertNotInt16Array<T>(value: T, message: string = 'expected value to not be Int16Array'): asserts value is InferIsNotType<T, typeof isInt16Array> { assert(isNotInt16Array(value), message); }
export function assertInt16ArrayPass(value: any, message?: string): InferIsType<typeof isInt16Array> { assertInt16Array(value, message); return value; }
export function assertNotInt16ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isInt16Array> { assertNotInt16Array(value, message); return value; }
...
export function assertUint16Array(value: any, message: string = 'expected value to be Uint16Array'): asserts value is InferIsType<typeof isUint16Array> { assert(isUint16Array(value), message); }
export function assertNotUint16Array<T>(value: T, message: string = 'expected value to not be Uint16Array'): asserts value is InferIsNotType<T, typeof isUint16Array> { assert(isNotUint16Array(value), message); }
export function assertUint16ArrayPass(value: any, message?: string): InferIsType<typeof isUint16Array> { assertUint16Array(value, message); return value; }
export function assertNotUint16ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isUint16Array> { assertNotUint16Array(value, message); return value; }
...
export function assertInt32Array(value: any, message: string = 'expected value to be Int32Array'): asserts value is InferIsType<typeof isInt32Array> { assert(isInt32Array(value), message); }
export function assertNotInt32Array<T>(value: T, message: string = 'expected value to not be Int32Array'): asserts value is InferIsNotType<T, typeof isInt32Array> { assert(isNotInt32Array(value), message); }
export function assertInt32ArrayPass(value: any, message?: string): InferIsType<typeof isInt32Array> { assertInt32Array(value, message); return value; }
export function assertNotInt32ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isInt32Array> { assertNotInt32Array(value, message); return value; }
...
export function assertUint32Array(value: any, message: string = 'expected value to be Uint32Array'): asserts value is InferIsType<typeof isUint32Array> { assert(isUint32Array(value), message); }
export function assertNotUint32Array<T>(value: T, message: string = 'expected value to not be Uint32Array'): asserts value is InferIsNotType<T, typeof isUint32Array> { assert(isNotUint32Array(value), message); }
export function assertUint32ArrayPass(value: any, message?: string): InferIsType<typeof isUint32Array> { assertUint32Array(value, message); return value; }
export function assertNotUint32ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isUint32Array> { assertNotUint32Array(value, message); return value; }
...
export function assertFloat32Array(value: any, message: string = 'expected value to be Float32Array'): asserts value is InferIsType<typeof isFloat32Array> { assert(isFloat32Array(value), message); }
export function assertNotFloat32Array<T>(value: T, message: string = 'expected value to not be Float32Array'): asserts value is InferIsNotType<T, typeof isFloat32Array> { assert(isNotFloat32Array(value), message); }
export function assertFloat32ArrayPass(value: any, message?: string): InferIsType<typeof isFloat32Array> { assertFloat32Array(value, message); return value; }
export function assertNotFloat32ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isFloat32Array> { assertNotFloat32Array(value, message); return value; }
...
export function assertFloat64Array(value: any, message: string = 'expected value to be Float64Array'): asserts value is InferIsType<typeof isFloat64Array> { assert(isFloat64Array(value), message); }
export function assertNotFloat64Array<T>(value: T, message: string = 'expected value to not be Float64Array'): asserts value is InferIsNotType<T, typeof isFloat64Array> { assert(isNotFloat64Array(value), message); }
export function assertFloat64ArrayPass(value: any, message?: string): InferIsType<typeof isFloat64Array> { assertFloat64Array(value, message); return value; }
export function assertNotFloat64ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isFloat64Array> { assertNotFloat64Array(value, message); return value; }
...
export function assertBigInt64Array(value: any, message: string = 'expected value to be BigInt64Array'): asserts value is InferIsType<typeof isBigInt64Array> { assert(isBigInt64Array(value), message); }
export function assertNotBigInt64Array<T>(value: T, message: string = 'expected value to not be BigInt64Array'): asserts value is InferIsNotType<T, typeof isBigInt64Array> { assert(isNotBigInt64Array(value), message); }
export function assertBigInt64ArrayPass(value: any, message?: string): InferIsType<typeof isBigInt64Array> { assertBigInt64Array(value, message); return value; }
export function assertNotBigInt64ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isBigInt64Array> { assertNotBigInt64Array(value, message); return value; }
...
export function assertBigUint64Array(value: any, message: string = 'expected value to be BigUint64Array'): asserts value is InferIsType<typeof isBigUint64Array> { assert(isBigUint64Array(value), message); }
export function assertNotBigUint64Array<T>(value: T, message: string = 'expected value to not be BigUint64Array'): asserts value is InferIsNotType<T, typeof isBigUint64Array> { assert(isNotBigUint64Array(value), message); }
export function assertBigUint64ArrayPass(value: any, message?: string): InferIsType<typeof isBigUint64Array> { assertBigUint64Array(value, message); return value; }
export function assertNotBigUint64ArrayPass<T>(value: T, message?: string): InferIsNotType<T, typeof isBigUint64Array> { assertNotBigUint64Array(value, message); return value; }
...
export function assertDataView(value: any, message: string = 'expected value to be DataView'): asserts value is InferIsType<typeof isDataView> { assert(isDataView(value), message); }
export function assertNotDataView<T>(value: T, message: string = 'expected value to not be DataView'): asserts value is InferIsNotType<T, typeof isDataView> { assert(isNotDataView(value), message); }
export function assertDataViewPass(value: any, message?: string): InferIsType<typeof isDataView> { assertDataView(value, message); return value; }
export function assertNotDataViewPass<T>(value: T, message?: string): InferIsNotType<T, typeof isDataView> { assertNotDataView(value, message); return value; }
...
export function assertSet<T>(value: Set<T> | any, message: string = 'expected value to be Set'): asserts value is Set<T> { assert(isSet(value), message); }
export function assertNotSet<T>(value: T, message: string = 'expected value to not be Set'): asserts value is InferIsNotType<T, typeof isSet> { assert(isNotSet(value), message); }
export function assertSetPass<T>(value: Set<T> | any, message?: string): Set<T> { assertSet(value, message); return value as Set<T>; }
export function assertNotSetPass<T>(value: T, message?: string): InferIsNotType<T, typeof isSet> { assertNotSet(value, message); return value; }
...
export function assertMap<K, V>(value: Map<K, V> | any, message: string = 'expected value to be Map'): asserts value is Map<K, V> { assert(isMap(value), message); }
