import type { HttpBufferBodyType, HttpStreamBodyType } from '../types';
...
export abstract class HttpClientAdapter {
   ...
   */
  abstract call(request: HttpClientRequest): Promise<HttpClientResponse<HttpBufferBodyType | HttpStreamBodyType>>;
}
