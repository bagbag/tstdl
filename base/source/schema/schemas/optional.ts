...
export function Optional<T>(schema?: SchemaTestable<T>, options?: TypedOmit<SchemaDecoratorOptions, 'optional'>): SchemaPropertyDecorator {
  return createSchemaDecorator({ schema: () => schema as SchemaTestable, ...options, optional: true });
}
