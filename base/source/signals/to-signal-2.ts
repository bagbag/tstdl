...
export function toSignal2<T>(source: Subscribable<T>): Signal<T | undefined>;
export function toSignal2<T>(source: Subscribable<T>, options: ToSignal2Options<undefined> & { requireSync: true }): Signal<T>;
export function toSignal2<T, const I = undefined>(source: Subscribable<T>, options: ToSignal2Options<I> & { requireSync?: false }): Signal<T | I>;
export function toSignal2<T, const I = undefined>(source: Subscribable<T>, options?: ToSignal2Options<I>): Signal<T | I> {
