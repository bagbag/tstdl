...
export class NumberLocalePipe implements PipeTransform {
  ...
  transform(value: number | null, options?: Intl.NumberFormatOptions): string | null;
  transform(value: number | null, localesOrOptions?: string | string[] | Intl.NumberFormatOptions, optionsOrNothing?: Intl.NumberFormatOptions): string | null {
    if (isNull(value)) {
      return null;
    }
